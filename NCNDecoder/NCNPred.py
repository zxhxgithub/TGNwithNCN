...
class NCNPredictor(torch.nn.Module):
    ...
    def __init__(self,
        ...
        self.xlin = Linear(hidden_channels, hidden_channels)
        self.xcnlin = Linear(in_channels, hidden_channels)
        self.xijlini = Linear(in_channels, hidden_channels)
        self.xijlinj = Linear(in_channels, hidden_channels)
        self.xijfinal = Linear(in_channels, hidden_channels)
        self.lin = Linear(hidden_channels, hidden_channels)
        self.xslin = Linear(hidden_channels, out_channels)
